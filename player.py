...
from Ability import ABILITY_DICT
...
class Square(pygame.sprite.Sprite):
    def __init__(self, defLoc = (0, 0)):
        ...
        # CharacterInfo is used in the enemies' reactive AI and the Ability Manager.
        self.CharacterInfo = {'Vel': (self.Velx, self.Vely), 'Loc': (self.x, self.y)}

        # Character Ability Stuff
        self.AbilityDict = ABILITY_DICT
        self.AbilityQ = ABILITY_DICT['']
        self.AbilityE = ABILITY_DICT['']
    ...
    def updateAbilities(self, userInput, dT):
        if userInput['q']: self.AbilityQ.activate(userInput, dT, self)
        elif userInput['e']: self.AbilityE.activate(userInput, dT, self)
